...
2. [Лодочные системы](#2-Лодочные-системы)  
    ...
    2.3 [Вентяля заполнения балласта](#23-Вентяля-заполнения-балласта)  
    ...
    2.7 [Машинные телеграфы](#27-Машинные-телеграфы)  
...
## 2.3 Вентяля заполнения балласта
